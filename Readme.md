...
Instrucciones de Ejecución
    ...
    Compilación: Asegúrate de tener todos los archivos fuente (Arbol_AVL.h, Nodo_AVL.h, Persistencia.h y el archivo principal .cpp) en el mismo directorio. Compila utilizando tu compilador preferido (ej. g++):
    Bash
...
Agrega un nuevo registro con su ID y datos.  
...
Modifica los datos de un ID existente.  
	db> act 101 Juan Alberto Perez
borrar	

Elimina un registro existente del árbol.  
	db> borrar 101
orden	

Muestra todos los registros ordenados por clave.  
	db> orden
salir	
...
Desarrollado como sistema de gestión con balanceo AVL para optimización de búsqueda.
